...
class HomeCollectionViewLayout: NSObject {
    ...
    func createLayout() -> UICollectionViewCompositionalLayout {
        return UICollectionViewCompositionalLayout { (section, _) -> NSCollectionLayoutSection? in
            switch section {
            case 0:
                return self.layoutForFirstSection()
            case 1:
                return self.layoutForSecondSection()
            default:
                return self.layoutForFirstSection()
            }
        }
    ...
    private func layoutForFirstSection() -> NSCollectionLayoutSection {
        let item = NSCollectionLayoutItem(
            layoutSize: .init(
                widthDimension: .fractionalWidth(1.0),
                heightDimension: .fractionalHeight(1.0)))
        item.contentInsets = NSDirectionalEdgeInsets(top: 0, leading: 30, bottom: 16, trailing: 5)
    ...
    private func layoutForSecondSection() -> NSCollectionLayoutSection {
        let item = NSCollectionLayoutItem(
            layoutSize: .init(
                widthDimension: .fractionalWidth(1.0),
                heightDimension: .fractionalHeight(1.0)))
        item.contentInsets = NSDirectionalEdgeInsets(top: 16, leading: 15, bottom: 16, trailing: 15)
...
extension HomeCollectionViewLayout: UICollectionViewDelegate {
...
extension HomeCollectionViewLayout: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        case 0:
            cell = collectionView.dequeueReusableCell(withReuseIdentifier: Constants.priorityCollectionViewCell, for: indexPath)
        default:
            cell = collectionView.dequeueReusableCell(withReuseIdentifier: Constants.defaultCollectionViewCell, for: indexPath)
        }
