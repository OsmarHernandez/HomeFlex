...
class HomeCollectionViewLayout: NSObject {
    ...
    func createLayout() -> UICollectionViewCompositionalLayout {
        return UICollectionViewCompositionalLayout { (_, _) -> NSCollectionLayoutSection? in
            return self.layoutForRoomCollectionViewCell()
        }
    }
    
    private func layoutForRoomCollectionViewCell() -> NSCollectionLayoutSection {
...
extension HomeCollectionViewLayout: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let roomCell = collectionView.dequeueReusableCell(withReuseIdentifier: Constants.roomCollectionViewCell, for: indexPath) as! RoomCollectionViewCell
        
        roomCell.homeImageView.backgroundColor = colorData[indexPath.item]
